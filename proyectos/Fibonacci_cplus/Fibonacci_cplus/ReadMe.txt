========================================================================
    APLICACIÓN DE CONSOLA: Fibonacci_cplus 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Fibonacci_cplus.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Fibonacci_cplus.


Fibonacci_cplus.vcxproj
...
Fibonacci_cplus.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Fibonacci_cplus.pch y un archivo de tipos 
